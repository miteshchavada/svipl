...
/* AcmeInfoBundle:Work:edit.html.twig */
class __TwigTemplate_1179b186b992d0e8eaba38171d825de8954ee99a59f6b4320a7a420a1fe315e0 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "        <div class=\"row\">
            <div class=\"col-lg-12\">
                <h1 class=\"page-header\">Edit Work</h1>
            </div>
        </div>
        <div class=\"row\">
            <center>
                <form action=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("acme_work_edit", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "html", null, true);
        ...
        echo "
                        <div class=\"col-sm-1\">
                            <img src=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(twig_join_filter(array(0 => "uploads/works/", 1 => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), 2 => "/", 3 => (isset($context["image"]) ? $context["image"] : $this->getContext($context, "image"))))), "html", null, true);
    ...
    {
        return "AcmeInfoBundle:Work:edit.html.twig";
    }
