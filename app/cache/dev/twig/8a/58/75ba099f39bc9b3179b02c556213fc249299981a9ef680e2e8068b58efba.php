...
/* AcmeInfoBundle:People:edit.html.twig */
class __TwigTemplate_8a5875ba099f39bc9b3179b02c556213fc249299981a9ef680e2e8068b58efba extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        echo "        <div class=\"row\">
            <div class=\"col-lg-12\">
                <h1 class=\"page-header\">Edit People</h1>
            </div>
        </div>
        <div class=\"row\">
            <center>
                <form action=\"";
        // line 11
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("acme_people_edit", array("id" => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")))), "html", null, true);
        ...
        echo "
                        <div class=\"col-sm-1\">
                            <img src=\"";
        // line 40
        echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(twig_join_filter(array(0 => "uploads/peoples/", 1 => (isset($context["id"]) ? $context["id"] : $this->getContext($context, "id")), 2 => "/", 3 => (isset($context["image"]) ? $context["image"] : $this->getContext($context, "image"))))), "html", null, true);
    ...
    {
        return "AcmeInfoBundle:People:edit.html.twig";
    }
