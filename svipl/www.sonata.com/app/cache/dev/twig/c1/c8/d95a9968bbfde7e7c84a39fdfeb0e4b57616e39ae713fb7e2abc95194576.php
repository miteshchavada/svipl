...
class __TwigTemplate_c1c8d95a9968bbfde7e7c84a39fdfeb0e4b57616e39ae713fb7e2abc95194576 extends Twig_Template
{
    ...
    public function block_content($context, array $blocks = array())
    {
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["followus"]) ? $context["followus"] : $this->getContext($context, "followus")));
        $context['loop'] = array(
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["follow"]) {
            ...
            echo "</td>
                                            <td>";
            // line 36
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["follow"]) ? $context["follow"] : $this->getContext($context, "follow")), "title"), "html", null, true);
            echo "</td>
                                            <td><img src=\"";
            // line 37
            ...
            echo "\"/></td>
                                            <td width=\"250px;\">";
            // line 38
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["follow"]) ? $context["follow"] : $this->getContext($context, "follow")), "link"), "html", null, true);
            echo "</td>
                                            <td>
\t\t\t\t\t\t<a href=\"";
            // line 40
        ...
        \t\t\t\t\t<a href=\"";
            // line 41
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("acme_followdelete", array("id" => $this->getAttribute((isset($context["follow"]) ? $context["follow"] : $this->getContext($context, "follow")), "id"))), "html", null, true);
            ...
            if ($this->env->getExtension('security')->isGranted("ROLE_ADMIN")) {
                // line 43
                echo "                                                ";
                if (($this->getAttribute((isset($context["follow"]) ? $context["follow"] : $this->getContext($context, "follow")), "status") == "1")) {
                    // line 44
                    echo "                                                    <a href=\"javascript:void(0)\" class=\"btn btn-success btn-follow-status\" id=\"";
                    echo twig_escape_filter($this->env, $this->getAttribute((isset($context["follow"]) ? $context["follow"] : $this->getContext($context, "follow")), "id"), "html", null, true);
                    echo "\">Enable</a>
                                                    ";
                    // line 46
                    echo "                                                ";
